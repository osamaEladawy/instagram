...
import '../../user/presentation/widgets/auth/custom_dialog.dart';
import '../../posts/widgets/like_animation.dart';
...
class _CommentCardState extends State<CommentCard> {
  @override
  void initState() {
    CommentsCubit.instance.time = widget.comSnap['datePublished'];
          ...
          onLongPress: () {
            showDialog(
              ...
              builder: (context) => DialogForPassword(
                ...
                onPressed: () async {
                  await CommentsCubit.instance.deleteComments(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            Jiffy.parse(
                                    "${CommentsCubit.instance.time.toDate()}")
                                .fromNow(),
                          )
                        ],
                      ),
                      ...
                      user!.uid != widget.comSnap['useruid']
                          ...
                          : GestureDetector(
                              child: const Text(
                                "Edit...",
                                style: TextStyle(
                                    fontSize: 15.5, color: Colors.pink),
                              ),
                              onTap: () async {
                                // showDialog(
                                //     context: context,
                                          ...
                                          widget: ListView.builder(
                                              ...
                                              itemBuilder: (context, index) {
                                                ...
                                                return ListView.builder(
                                                    ...
                                                    itemBuilder:
                                                        (context, index) {
                                                      String res = likes[index]
                                                          .toString();
                                                      List convertToList =
                                                          res.split(' ');
                                                      String getUsers =
                                                          PrefServices.getData(
                                                              key: 'uid')!;
                                                      return Card(
                                                        child: ListTile(
                                                          onTap: () {},
