...
class RilesDottedBordersWidget extends CustomPainter {
  //number of stories
  ...
  final String? uid;
  final List<RilesImageEntity>? images;
  final bool isMe;

  //start of the arc painting in degree(0-360)
  double startOfArcInDegree = 0;

  RilesDottedBordersWidget({required this.numberOfStories,
    this.spaceLength = 10,
    this.uid,
    this.images,
    required this.isMe });
  ...
  @override
  bool shouldRepaint(RilesDottedBordersWidget oldDelegate) {
    return true;
  }
