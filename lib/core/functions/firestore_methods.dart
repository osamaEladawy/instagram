...
import 'package:inistagram/core/functions/storaged_method.dart';
import 'package:inistagram/core/shared/snackbar.dart';
import 'package:inistagram/data/model/comment_model.dart';
import 'package:inistagram/data/model/comment_save_post_model.dart';
import 'package:inistagram/data/model/post_model.dart';
import 'package:inistagram/data/model/relis_model.dart';
...
class FireStoreMethods {
    ...
    try {
      ...
      if (likes.contains(user)) {
        ...
        await _store.collection("posts").doc(postId).update({
          ...
          if (users != null && preferences.getString('uid') != null) {
            await _store
                .collection("users")
                .doc(users.uid)
                .get()
  ...
  Future<void> postComment({
    ...
    if (text.isNotEmpty && preferences.getString('uid') != null) {
      try {
        final collectionRef =
