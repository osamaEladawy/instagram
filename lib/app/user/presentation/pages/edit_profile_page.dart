...
import 'package:inistagram/app/user/presentation/manager/user/user_cubit.dart';
import 'package:inistagram/app/user/presentation/widgets/editprofile.dart/profilritem.dart';
import 'package:inistagram/app/user/presentation/widgets/editprofile.dart/savedateforuser.dart';
import 'package:inistagram/app/user/presentation/widgets/editprofile.dart/settingitemwidget.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            SaveDataForUser(onTap: submitProfileInfo, isProfileUpdating: _isProfileUpdating,),
          ],
        ),
      ),
    );
